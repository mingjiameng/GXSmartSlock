...
@implementation zkeyIdentifierValidator
...
/*
 ...
 电信有4个号段：133、153、180、189、177。其中189是3G号段（CDMA2000），133号段主要用作无线网卡号。
...
{
    NSString *regex = @"^((13[0-9])|(14[5,7])|(17[0,1,6,7,8])|(15[^4,\\D])|(18[0-9]))\\d{8}$";
