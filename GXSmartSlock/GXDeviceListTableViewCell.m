...
- (void)layoutSubviews
{
    ...
    self.textLabel.frame = CGRectMake(100.0f, 15.0f, self.frame.size.width - 170.0f, 35.0f);
    
    self.detailTextLabel.frame = CGRectMake(100.0f, 50.0f, self.frame.size.width - 170.0f, 15.0f);
}
