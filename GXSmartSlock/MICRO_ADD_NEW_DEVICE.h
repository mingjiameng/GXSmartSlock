...
#define GX_PAIR_CHARACTERISTIC_READ_DEVICE_CATEGORY [CBUUID UUIDWithString:@"FFF8"]
...
#define DEVICE_CATEGORY @"deviceCategory"
...
#define GX_PAIR_DEFAULT_DEVICE_CATEGORY @"0101"
